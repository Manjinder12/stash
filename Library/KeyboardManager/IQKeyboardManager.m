...
-(void)addToolbarIfRequired
{
	...
	if (siblings.count==1)
	{
		...
		{
			[[siblings objectAtIndex:0] addCancelDoneOnKeyboardWithTarget:self cancelAction:@selector(cancelAction:) doneAction:@selector(doneAction:)];
		}
	}
	else
	{
...
//	Cancel button action. Resigning current textField.
