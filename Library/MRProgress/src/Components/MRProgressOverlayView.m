...
+ (instancetype)showOverlayAddedTo:(id)view animated:(BOOL)animated {
...
- (void)commonInit {
    ...
    self.titleLabel.attributedText = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Loading...", nil) attributes:@{
        NSForegroundColorAttributeName: UIColor.blackColor,
        NSFontAttributeName:            [ApplicationUtils GETFONT_MEDIUM:20],
