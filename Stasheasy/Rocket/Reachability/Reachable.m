...
////            DLog(@"%@", temp);
//            [[NSNotificationCenter defaultCenter] postNotificationName:NETWORK_REACHABILITY_NOTIFY object:nil];
//        }
//        else
//        {
////            NSString * temp = [NSString stringWithFormat:@"GOOGLE Notification Says Unreachable(%@)", reach.currentReachabilityString];
////            DLog(@"temp = %@",temp);
//            [[NSNotificationCenter defaultCenter] postNotificationName:NETWORK_UNREACHABILITY_NOTIFY object:nil];
//        }
//    }
