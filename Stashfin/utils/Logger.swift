...
//    print("***** \(Date()) \(filename.components(separatedBy: "/").last ?? "") (line: \(line)) :: \(funcname) :: \(object)")
    print("\(LogEvent.s.rawValue) :: \(object) :: \(filename.components(separatedBy: "/").last ?? "") :: \(funcname)  ")
    #endif
}
...
//    ///   - column: Column number of the log message
//    ///   - funcName: Name of the function from where the logging is done
//    class func warnings( _ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
//        if isLoggingEnabled {
...
//    ///   - column: Column number of the log message
//    ///   - funcName: Name of the function from where the logging is done
//    class func servers( _ object: String, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
//        if isLoggingEnabled {
////            print("\(Date().toString()) \(LogEvent.s.rawValue)[\(sourceFileName(filePath: filename))]:\(line) \(column) \(funcName) -> \(object)")
//            print("\(LogEvent.s.rawValue) -> \(object) *** [\(sourceFileName(filePath: filename))]:\(line)")
//        }
//    }
//
//
